...
- **The shop**: 32 original monsters (a Komodo dragon among the early saves, a striker in a number 7 shirt, an excavator; seven dragons, each a different form with a different breath; eight hybrid kaiju, among them a hoops-shooting tower, a jet pilot, a moon-howling wolf, a three-headed hydra, a skyscraper-wrecking wolf-dragon, a gold-clawed panther), 30 helmets (sports lids and a hard hat among them), 15 boards (a plain one always yours, fourteen to save for, each with its own deck graphic and a trail while it rides; among them a fighter jet with a cockpit nose, a hockey rink, a basketball court, and a graffiti tag), all with in-character idle acts — boulders fall for the quarry beast, the storm titan gets rained on, the night serpent vanishes while his trophy relocates.
