...
- **The Skate Park**: finishing the day's dose drops a Daily Token; a token buys a few minutes (a parent dial) in a pure touch skateboarding game with the rider's own monster, board and helmet. Tap to ollie, hold for bigger, swipe for tricks, grind rails, chain for multipliers, bail if you land early. A parent cap on tokens per day keeps it a reward, not an afternoon. Extra tokens can be earned past the day's work: up to N more, one for every M problems landed, both dials the parent's, and the whole offer switchable.
