...
- **The Skate Park**: finishing the day's dose drops a Daily Token; a token buys a few minutes (a parent dial) in a pure touch skateboarding game with the rider's own monster, board and helmet. Tap to ollie, hold for bigger, swipe for tricks, grind rails, chain for multipliers, bail if you land early. A rail set that climbs can end in a half pipe, a handrail slanting down a staircase, or the bare steps to ride down. A parent cap on tokens per day keeps it a reward, not an afternoon. Extra tokens can be earned past the day's work: up to N more, one for every M problems landed, both dials the parent's, and the whole offer switchable.
- **Half Pipe Duels**: the park's tricks and fast recall in one game. His skater against a computer skater on one big half pipe, in blocks of five: five runs of his (drop in, tap to ollie on the flat, swipe for tricks out of the lip, land on the far deck), then five problems, each over a meter that drains across the recall threshold; solve one in time and the computer messes up that run, so solving everything wins for certain and skating well is the margin. Ten, fifteen or twenty rounds, the problems exactly the parent's practice settings (never a bonus question, never dots), the opponent any monster in any lid on any deck but his, a line of good-sport trash talk before the match in the rival's own recorded British voice, a winner's dance with a chiptune after, and a won/lost record per length. Your tricks never bail in a duel and quick repeat swipes stack them (720s, 1080s, double and triple flips); the rival keeps pace with your skating, and under sixty percent solved in time the duel is theirs whatever the scores. One duel token a day (a play of each length), one more with the day's work, and a grown-up can give more. It never touches the practice evidence.
- **The shop**: 38 original monsters (a Komodo dragon among the early saves, a striker in a number 7 shirt, an excavator, a ninja, a dark knight, a batter, a football player, a motocross rider who hops on his bike and rides off in a spray of dirt, a princess in a pink gown who twirls; seven dragons, each a different form with a different breath; eight hybrid kaiju, among them a hoops-shooting tower, a jet pilot, a moon-howling wolf, a three-headed hydra, a skyscraper-wrecking wolf-dragon, a gold-clawed panther), 40 helmets (sports lids, a hard hat, a ninja band, a great helm and a gold tiara among them), 21 boards (a plain one always yours, twenty to save for, each with its own deck graphic and a trail while it rides; among them a fighter jet with a cockpit nose, a hockey rink, a basketball court, a dirt track, a princess deck, and a graffiti tag), all with in-character idle acts — boulders fall for the quarry beast, the storm titan gets rained on, the night serpent vanishes while his trophy relocates.
