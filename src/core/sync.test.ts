...
const base: SyncedSettings = {
  ...
  addDots: false, dailyGoal: 40, speedLimit: 10, elapsedOn: true, elapsedLevel: 1, elapsedAnalog: false, parkMinutes: 7, parkTokensPerDay: 3, dayLimitMinutes: 0,
};
...
describe("merge, under fire", () => {
  ...
  const randomFields = (): Fields => {
    ...
    for (const k of ["addDots", "dailyGoal", "speedLimit", "elapsedOn", "elapsedLevel", "elapsedAnalog", "parkMinutes", "parkTokensPerDay", "dayLimitMinutes"] as const) {
